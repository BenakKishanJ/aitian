      ...
      <VStack className="flex-1 p-6" space="md">
        ...
        <VStack space="md" className="flex-1">
          ...
          <VStack space="sm" className="mt-4">
            <Text className="text-lg font-semibold text-gray-800">Academic Details</Text>
            ...
            <HStack space="md">
              ...
              <FormControl className="flex-1" isInvalid={!!errors.semester}>
                ...
                {errors.semester && (
                  <HStack className="mt-1 items-center" space="xs">
                    <AlertCircle size={14} color="#EF4444" />
                    <Text className="text-red-500 text-sm">{errors.semester}</Text>
                  </HStack>
                )}
              </FormControl>
              ...
              <FormControl className="flex-1" isInvalid={!!errors.section}>
                ...
                {errors.section && (
                  <HStack className="mt-1 items-center" space="xs">
                    <AlertCircle size={14} color="#EF4444" />
                    <Text className="text-red-500 text-sm">{errors.section}</Text>
                  </HStack>
                )}
              </FormControl>
            </HStack>
          ...
          {/* Terms Agreement */}
          <HStack className="items-start mt-4 p-4 bg-blue-50 rounded-lg" space="sm">
            <BookOpen size={20} color="#3B82F6" />
            <Text className="flex-1 text-gray-700 text-sm">
              By registering, you agree to our Terms of Service and confirm that all information provided is accurate.
            </Text>
          </HStack>
        </VStack>
        ...
        <Button
          ...
          isDisabled={loading}
          className="mt-4 bg-blue-500 active:bg-blue-600"
        >
